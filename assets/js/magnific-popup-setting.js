$(document).ready(function() {
  ...
  $('.page__content img[id="magnific"]').wrap( function(){
    ...
    // 2.4. 이미지를 감쌀 태그 설정.
    return '<a href="' + $(this).attr('src') + '" style="width:' + $(this).attr('width') +'px; float: left;"><figure> </figure>' + '<figcaption style="text-align: center;" class="caption">' + $(this).attr('title') + '</figcaption>' + '</a>';
  });
});